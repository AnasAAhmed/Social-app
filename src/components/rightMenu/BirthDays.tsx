    ...
    return (
        <div className='p-4 bg-white dark:bg-[#111] rounded-lg text-sm shadow-md flex flex-col gap-4'>
            <div className="flex justify-between items-center font-medium">
                ...
                <ProgressBar title='Click here to see real dynamic Reminder' href={'/friends/reminders'} className='text-blue-500 text-xs'>See all</ProgressBar>
            </div>

            {/* Today's Birthdays */}
            <div className="flex flex-col gap-4">
                <div className="flex justify-between items-center">
                    <ProgressBar href={`/profile/anas`} className="flex items-center gap-4">
                ...
                <div className="flex justify-between items-center">
                    <ProgressBar href={`/profile/hafeez`} className="flex items-center gap-4">
            ...
            <div className="p-4 dark:bg-[#252525] bg-slate-100 rounded-lg flex flex-col gap-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <ProgressBar href={`/profile/john`} className='text-xs text-gray-500 dark:text-white'>@john</ProgressBar>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <ProgressBar href={`/profile/doe`} className='text-xs text-gray-500 dark:text-white'>@doe</ProgressBar>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <ProgressBar href={`/profile/alan`} className='text-xs text-gray-500 dark:text-white'>@alan</ProgressBar>
                    <span className="text-xs dark:text-white text-gray-500">2002-09-03</span>
                </div>
                <ProgressBar title='Click here to see real dynamic Reminder' href={'/friends/reminders'} className='text-blue-500 text-xs'>See all upcoming birthdays</ProgressBar>
            </div>
