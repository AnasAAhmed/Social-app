            ...
            <div className="flex flex-col gap-4">
                <div className="flex justify-between items-center">
                    <Link href={`/profile/anas`} className="flex items-center gap-4">
                        <img src={'https://res.cloudinary.com/dfhbykzdi/image/upload/v1744370903/Social/t7vglw6lqtnu2azbibob.png'} alt='static avatar' className='w-10 h-10 rounded-full object-cover' />
