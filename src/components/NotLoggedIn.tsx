    ...
    return (
        <div className="flex flex-col items-center pt-24 min-h-screen">
            ...
            <div className='flex items-center gap-3'>
                ...
                <SmartLink title="go to Login" className='p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md' prefetch={false} href={`/login?redirect_url=${decodeURIComponent(pathname)}`}>
                    Login
                </SmartLink>
                <SmartLink title="go to signup" className='p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md' prefetch={false} href={`/sign-up?redirect_url=${decodeURIComponent(pathname)}`}>
                    Signup
                </SmartLink>
    ...
    return (
        <div className="flex flex-col items-center pt-24 min-h-screen">
            ...
            <div className='flex items-center mt-3 gap-3'>
                <SmartLink href={'/'} className='p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md'>Go back to the homepage</SmartLink>
            </div>
        </div>
    );
}
...
export const NotFound = ({ currentUser=false,text = 'Page Not Found' }: {currentUser?:boolean; text?: string }) => {
    return (
        <div className="flex flex-col items-center pt-24 min-h-screen">
            ...
            <div className='flex items-center gap-3'>
                <SmartLink href={currentUser?'/':'/login'} className='p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md'>Go back to the homepage</SmartLink>
            </div>
        </div>
    );
}
